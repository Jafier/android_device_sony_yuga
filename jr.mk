...
$(call inherit-product, vendor/jr/config/gsm.mk)

# Enhanced NFC
$(call inherit-product, vendor/jr/config/nfc_enhanced.mk)

# Inherit CM common Phone stuff.
$(call inherit-product, vendor/jr/config/common_full_phone.mk)
